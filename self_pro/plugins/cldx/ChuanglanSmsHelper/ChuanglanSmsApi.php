...
//require_once("Chuanglan_config.php");  //这句是配置文件，直接拿过来了
class ChuanglanSmsApi {
	public $chuanglan_config = '';
	public function __construct(){
		//创蓝发送短信接口URL, 请求地址请参考253云通讯自助通平台查看或者询问您的商务负责人获取
		$this->chuanglan_config['api_send_url'] = SYS('short_message.keyword1');

		//创蓝变量短信接口URL, 请求地址请参考253云通讯自助通平台查看或者询问您的商务负责人获取
		$this->chuanglan_config['API_VARIABLE_URL'] = SYS('short_message.keyword2');

		//创蓝短信余额查询接口URL, 请求地址请参考253云通讯自助通平台查看或者询问您的商务负责人获取
		$this->chuanglan_config['api_balance_query_url'] = SYS('short_message.keyword3');
		//创蓝账号 替换成你自己的账号
		$this->chuanglan_config['api_account']	= SYS('short_message.username');

		//创蓝密码 替换成你自己的密码
		$this->chuanglan_config['api_password']	= SYS('short_message.password');
	}
	/**
	 * 发送短信
	 *
	...
	public function sendSMS( $mobile, $msg, $needstatus = 'true') {
		$chuanglan_config = $this->chuanglan_config;
