<?php
echo date('Y-m-d-H-i-s',1479177799);
//(1483246800 - ((int)(1483246800/86400)*86400) + 28800)/3600;die;
//(create_time - ((create_time/86400)*86400) + 28800)/3600
//SELECT * FROM `oc_plan_order` WHERE 13 <= (create_time - ((create_time/86400)*86400) + 28800)/3600 and 14 >= (create_time - ((create_time/86400)*86400) + 28800)/3600
//SELECT * FROM `oc_plan_order` WHERE 5 <= (create_time - ((create_time/86400)*86400) + 28800)/3600 and 23 >= (create_time - ((create_time/86400)*86400) + 28800)/3600
class mysql{
	private $config = '';
