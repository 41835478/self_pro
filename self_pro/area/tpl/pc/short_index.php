...
<html>
    ...
    <body>
		...
		<div class="x-body">
			<a class="layui-btn" href="javascript:;" onclick="question_edit('编辑','?act=short&op=short_message_edit','','','510')" >短信配置</a>

			<?php if(isset($output['short_data'])){ ?> 
			<a class="layui-btn" href="javascript:;" onclick="question_edit('编辑','<?php echo $output['short_data']['url'];?>','','','510')" ><?php echo $output['short_data']['name'];?></a>
			<?php } ?>
		</div>
