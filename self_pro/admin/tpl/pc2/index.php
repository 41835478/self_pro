...
<section id="content" class="container">
	...
	<div id="messages" class="tile drawer animated">
		<div class="listview narrow">
			...
			<div class="overflow" style="height: 254px">
				<div class="media">
					<div class="pull-left">
						<img width="40" src="<?php echo IMG;?>/profile-pics/1.jpg" alt="">
					</div>
				...
				<div class="media">
					<div class="pull-left">
						<img width="40" src="<?php echo IMG;?>/profile-pics/2.jpg" alt="">
					</div>
					<div class="media-body">
				...
				<div class="media">
					<div class="pull-left">
						<img width="40" src="<?php echo IMG;?>/profile-pics/3.jpg" alt="">
					</div>
					<div class="media-body">
				...
				<div class="media">
					<div class="pull-left">
						<img width="40" src="<?php echo IMG;?>/profile-pics/4.jpg" alt="">
					</div>
					<div class="media-body">
				...
				<div class="media">
					<div class="pull-left">
						<img width="40" src="<?php echo IMG;?>/profile-pics/5.jpg" alt="">
					</div>
					<div class="media-body">
	...
	<div class="block-area shortcut-area">
		<a class="shortcut tile" href="">
			<img src="<?php echo IMG;?>/shortcuts/money.png" alt="">
			<small class="t-overflow"></small>
		</a>
		<a class="shortcut tile" href="">
			<img src="<?php echo IMG;?>/shortcuts/twitter.png" alt="">
			<small class="t-overflow"></small>
		</a>
		<a class="shortcut tile" href="">
			<img src="<?php echo IMG;?>/shortcuts/calendar.png" alt="">
			<small class="t-overflow"></small>
		</a>
		<a class="shortcut tile" href="">
			<img src="<?php echo IMG;?>/shortcuts/stats.png" alt="">
			<small class="t-overflow"></small>
		</a>
		<a class="shortcut tile" href="">
			<img src="<?php echo IMG;?>/shortcuts/connections.png" alt="">
			<small class="t-overflow">Connection</small>
		</a>
		<a class="shortcut tile" href="">
			<img src="<?php echo IMG;?>/shortcuts/reports.png" alt="">
		...
		<div class="row">
			<div class="col-md-3 col-xs-6">
				<div class="tile quick-stats">
					...
					<div class="data">
						<h2 ><?php echo $output['data']['new_user_num'];?></h2>
						<small>新进会员数（<?php echo $output['data']['day7'];?>到<?php echo $output['data']['day0'];?>）</small>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-xs-6">
				<div class="tile quick-stats media">
					...
					<div class="media-body">
						<h2 ><?php echo $output['data']['all_user_num'];?></h2>
						<small>总会员数</small>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-xs-6">
				<div class="tile quick-stats media">
					...
					<div class="media-body">
						<h2 ><?php echo $output['data']['all_goods'];?></h2>
						<small>商品数量（上架）</small>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-xs-6">
				<div class="tile quick-stats media">
					...
					<div class="media-body">
						<h2><?php echo $output['data']['all_store'];?></h2>
						<small>商铺数（开启）</small>
					</div>
				</div>
			</div>
	...
	<table class="tile table table-bordered table-striped" >
		<tr>
			<th>当前系统</th>
			<th><?php echo $output['data']['system'];?></th>
			<th>系统时间</th>
			<th><?php echo $output['data']['current_time'];?></th>
		</tr>
		<tr>
			<th>php版本</th>
			<th><?php echo $output['data']['php_v'];?></th>
			<th>服务器地址</th>
			<th><?php echo $output['data']['url'];?></th>
		</tr>
		<tr>
			<th>mysql版本</th>
			<th><?php echo $output['data']['mysql_v'];?></th>
			<th>服务器语言</th>
			<th><?php echo $output['data']['language'];?></th>
		</tr>
		<tr>
			<th>服务器运行方式</th>
			<th><?php echo $output['data']['php_run_state'];?></th>
			<th>网页端口</th>
			<th><?php echo $output['data']['web_port'];?></th>
		</tr>
		<!-- 没确定
		<tr>
			<th>图形库</th>
			<th><?php echo $output['data']['gd'];?></th>
			<th>网页端口</th>
			<th><?php echo $output['data']['web_port'];?></th>
		</tr>
		-->
				...
				<div class="tile text-center">
					<div class="tile-dark p-10">
						<div class="pie-chart-tiny" data-percent="86">
							...
							<span class="pie-title">CPU<!--<i class="m-l-5 fa fa-retweet"></i></span>
						</div>
						<div class="pie-chart-tiny" data-percent="23">
							<span class="percent"></span>
							<span class="pie-title">内存<!--<i class="m-l-5 fa fa-retweet"></i></span>
						</div>
					</div>
				</div>
				-->
	...
	<div class="chat">
		...
		<div class="pull-left chat-list">
			<div class="listview narrow">
				<div class="media">
					<img class="pull-left" src="<?php echo IMG;?>/profile-pics/1.jpg" width="30" alt="">
					<div class="media-body p-t-5">
						Alex Bendit
					</div>
				</div>
				<div class="media">
					<img class="pull-left" src="<?php echo IMG;?>/profile-pics/2.jpg" width="30" alt="">
					<div class="media-body">
						<span class="t-overflow p-t-5">David Volla Watkinson</span>
					</div>
				</div>
				<div class="media">
					<img class="pull-left" src="<?php echo IMG;?>/profile-pics/3.jpg" width="30" alt="">
					<div class="media-body">
						<span class="t-overflow p-t-5">Mitchell Christein</span>
					</div>
				</div>
				<div class="media">
					<img class="pull-left" src="<?php echo IMG;?>/profile-pics/4.jpg" width="30" alt="">
					<div class="media-body">
						<span class="t-overflow p-t-5">Wayne Parnell</span>
					</div>
				</div>
				<div class="media">
					<img class="pull-left" src="<?php echo IMG;?>/profile-pics/5.jpg" width="30" alt="">
					<div class="media-body">
						<span class="t-overflow p-t-5">Melina April</span>
					</div>
				</div>
				<div class="media">
					<img class="pull-left" src="<?php echo IMG;?>/profile-pics/6.jpg" width="30" alt="">
					<div class="media-body">
		...
		<div class="media-body">
			...
			<div class="chat-body">
				<div class="media">
					<img class="pull-right" src="<?php echo IMG;?>/profile-pics/1.jpg" width="30" alt="" />
				...
				<div class="media pull-right">
					<img class="pull-right" src="<?php echo IMG;?>/profile-pics/2.jpg" width="30" alt="" />
					<div class="media-body">
		...
		<ul class="browsers">
			<li>
				<a href="https://www.google.com/intl/en/chrome/browser/">
					<img src="<?php echo IMG;?>/browsers/chrome.png" alt="">
					<div>Google Chrome</div>
				</a>
			</li>
			<li>
				<a href="http://www.mozilla.org/en-US/firefox/new/">
					<img src="<?php echo IMG;?>/browsers/firefox.png" alt="">
					<div>Mozilla Firefox</div>
				</a>
			</li>
			<li>
				<a href="http://www.opera.com/computer/windows">
					<img src="<?php echo IMG;?>/browsers/opera.png" alt="">
					<div>Opera</div>
				</a>
			</li>
			<li>
				<a href="http://safari.en.softonic.com/">
					<img src="<?php echo IMG;?>/browsers/safari.png" alt="">
					<div>Safari</div>
				</a>
			</li>
			<li>
				<a href="http://windows.microsoft.com/en-us/internet-explorer/downloads/ie-10/worldwide-languages">
					<img src="<?php echo IMG;?>/browsers/ie.png" alt="">
