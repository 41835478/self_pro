...
<html>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo TPL;?>/favicon.ico" type="image/x-icon" />
    ...
    <body style="background-color: #393D49">
                    ...
                    <form class="layui-form">
                        <div class="layui-form-item x-login-box">
                            ...
                            <div class="layui-input-inline">
                                ...
                                autocomplete="off" placeholder="账户" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item x-login-box">
        ...
        <script src="<?php echo TPL;?>/js/jquery-1.9.1.min.js" charset="utf-8"></script>
