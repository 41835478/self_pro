...
class communityControl extends sysControl{
	...
	//	$_POST['keyword'] = isset($_POST['keyword']) ? $_POST['keyword'] : '';
		...
		//	array('radio','is_show','是否显示',array('1' => '显示' , '2' => '不显示')),
			...
			array('menu',array(
					array('编辑','javascript:;',array('style'=>'background:#FF5722','onclick' => "question_edit('编辑','?act=community&op=community_edit&id=__ID__','','1024','768')")),
	...
	//	$_POST['keyword'] = isset($_POST['keyword']) ? $_POST['keyword'] : '';
		...
		//	array('radio','is_show','是否显示',array('1' => '显示' , '2' => '不显示')),
			array('time','create_time','创建时间'),
			array('menu',array(
					array('编辑','javascript:;',array('style'=>'background:#FF5722','onclick' => "question_edit('编辑','?act=community&op=community_fedit&id=__ID__','','1024','768')")),
