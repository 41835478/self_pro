...
<body>
	...
	<a href="?act=payment&op=order_alipay&order_id=<?php echo $output['order']['order_id'];?>">
	<div class="dingdzf_4"  >
...
<script>
	...
	setInterval(function(){
		var url = '/api/api.php?commend=order_is_pay';
		$.post(url,{order_id:order_id,sign:sign},function(data){
			if(data.msg.code == 1){
