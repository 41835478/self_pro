window._bd_share_config = {
	common: {
		bdText: "我在玩《密室逃脱》，你敢来挑战我吗？",
		bdDesc: "我爱h5游戏源码，游戏AND源码，一个也不能少~",
		bdUrl: "www.52h5game.com/game/mishitaotuo",
		bdPic: ""
	},
	share: [{
		"bdSize": 16
...
(function() {
	...
	jsGame = {
		...
		play: function() {
			...
			var timer =  a.system.timeout - a.system.spendTime < 0 ? 0 : (a.system.timeout - a.system.spendTime - a.system.guankanandu) * this.canvas.screen.getFps()
		//	console.log(timer)
			setTimeout(a.system.run, timer);
			return this
		},
		pause: function() {
		...
		initImage: function(e) {
			...
			a.image.imgs[a.image.loadImgId].src = "/home/tpl/pc/game/2000.png";
			if(e.length > 0) {
				jsGame.pushImage(e);
