...
<body>
    <div class="dingdx_1">
        ...
        <a style='color:#f83600;text-decoration:underline;' href="?act=order&op=xiaofeiqingdan3&order_id=<?php echo $output['order']['order_id'];?>" ><span>消费清单</span></a>
    </div>
    <div class="dingdx_2">
        ...
        <div class="dingdx_2_2">
            <span class="dingdx_2_2_a">状态:交易成功</span>
